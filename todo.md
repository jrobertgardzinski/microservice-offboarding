...
- **Kompensacja sagi (ADR 0007) — WDROŻONE 2026-08-08.** Orkiestrator wysyła trzy komendy:
  ...
  - **`microservice-user-collections` nie jest uczestnikiem dwufazowym** — kasuje ulubione już na
    oznaczeniu, więc kompensacja ich nie odda. Komendy domknięcia i kompensacji ignoruje po
    `type`, więc nic nie wywraca. To jedyny znany dług tej zmiany.
